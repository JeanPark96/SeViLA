...
result_dir="/home/hlpark//REDUCE/REDUCE_benchmarks/SeViLA/sevila_tvqa_hirest_prediction_gt"
data='tvqa'
...
val_folder_list=('/home/hlpark/REDUCE/REDUCE_benchmarks/SeViLA/sevila_data/hirest_tvqa_original_pred/partial_val_hirest_gt_pt2.json'
        '/home/hlpark/REDUCE/REDUCE_benchmarks/SeViLA/sevila_data/hirest_tvqa_finetuned_on_visual_med/partial_val_hirest_gt_pt2.json'
        '/home/hlpark/REDUCE/REDUCE_benchmarks/SeViLA/sevila_data/hirest_tvqa_finetuned_on_visual_nonmed/partial_val_hirest_gt_pt2.json'
        '/home/hlpark/REDUCE/REDUCE_benchmarks/SeViLA/sevila_data/hirest_tvqa_finetuned_on_full_without_audio/partial_val_hirest_gt_pt2.json')

ckpt='sevila_checkpoints/sevila_pretrained.pth'

for idx in "${!exp_list[@]}"; do

    exp_name="${exp_list[$idx]}_pt2"
